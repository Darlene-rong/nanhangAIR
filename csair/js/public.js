  ...
  if (self == top) { //未开启工具条
    ...
    $(document).keyup(function (event) {
      ...
      if (keynum == '9') {
        ...
        $("html,body").animate({
          scrollTop: $("#focus_show_top").offset().top
        }, 200);
        $(".focus_lineshow").css({
          "display": "block"
        });
...
//验证明珠卡号
function yzMzNumber(val) {
  var contactFPNO = val.trim();
  if (contactFPNO != "") {
    var regex = /^(\d{8}|\d{12})?[^ ]/;
