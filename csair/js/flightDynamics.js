...
//	$("li[data-value='depArvCode'] a").css("color","#fff");
	...
	$("li[data-value='depArvCode']").click(function(){
		$("li[data-value='flightNum']").attr("class","nochoosed");
		
		$("li[data-value='depArvCode']").attr("class","choosed");
	...
	$("li[data-value='flightNum']").click(function(){
		$("li[data-value='depArvCode']").attr("class","nochoosed");
		$("li[data-value='flightNum']").attr("class","choosed");
