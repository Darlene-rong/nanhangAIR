/*
  $("#tzPage").tzPage(total, {
    ...
    current_page : $this.opts.page-1,//指明选中页码
    items_per_page :$this.opts.rows, //每页显示多条条
    prev_text : "上一页",
    next_text : "下一页",
    showGo:false,//显示
    showSelect:false,
    ...
    callback : function(page) {//会回传两个参数一个当前页，显示的页数
      $this.opts.page = page+1;
      $this.list();
    }
  });
*/
 ...
 ;(function($){
	...
	$.extend($.tzPageRenderers.defaultRenderer.prototype, {
      ...
      fragment.append("<div href='javascript:void(0);' style='display:inline-block;color:#989898'>共"+Math.ceil(this.maxentries/this.opts.items_per_page)+"页 共"+this.maxentries+"条记录</div>");
			return fragment;
