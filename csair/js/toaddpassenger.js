...
//		$(".add_pas_div:eq(0) .pType").remove();
			...
			$.ajax({
				...
				success : function(data) {
					if(data.state=="SUCCESS"){
						...
						var timestamp=new Date().getTime();
						$.ajax({
							url : 'addpassengerloadFilightInfo?'+timestamp,
							type : 'GET',
							dataType : 'html',
							sync : false,
							success : function(data) {
		...
		$.ajax({
			...
			success : function(data) {
				if(data.state=="SUCCESS"){
					...
					countreload();
					$.ajax({
						url : 'ir0checkBoxloadFilightInfo?'+timestamp,
						type : 'GET',
		...
		$.ajax({
			...
			success : function(data) {
				if(data.state=="SUCCESS"){
					...
					countreload();
					$.ajax({
						url : 'ir1checkBoxloadFilightInfo?'+timestamp,
						type : 'GET',
						data:{"checkBoxId":checkBoxId},
						dataType : 'html',
						sync : false,
		...
		$.ajax({
			...
			success : function(data) {
				if(data.state=="SUCCESS"){
					...
					countreload();
					$.ajax({
						url : 'delloadFilightInfo?'+timestamp,
						type : 'GET',
						data:{
							"divId":divId
						},
					...
					$.ajax({
						...
						success : function(data) {
							...
							if(data.state == "SUCCESS"){
								var timestamp=new Date().getTime();
								$.ajax({
									url : 'changePtypeloadFilightInfo?'+timestamp,
									type : 'GET',
									data:{},
									dataType : 'html',
									sync : false,
    ...
    //点击常用旅客
	function clickCommonPassenger(e){
		var ar = new Array();
		var p = {};
					...
					$.ajax({
						...
						success : function(data) {
							...
							if(data.state == "SUCCESS"){
								var timestamp=new Date().getTime();
								$.ajax({
									url : 'clickCommonPassengerloadFilightInfo?'+timestamp,
									type : 'GET',
									data:{},
									dataType : 'html',
									sync : false,
